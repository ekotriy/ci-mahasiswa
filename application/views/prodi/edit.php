            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="id_prodi" name="id_prodi" value="<?= $prodi['id_prodi'];?>">
                        ...
                        <button type="submit" name="submit"class="btn btn-primary float-right">Edit Prodi</button>
                    </form>
                </div>
            </div>
        </div>
